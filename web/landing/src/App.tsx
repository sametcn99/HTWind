...
function App() {
	...
	const faqItems = [
		...
		{
			question:
				"Can widgets auto-hide while I use fullscreen or maximized apps?",
			answer:
			...
			<main className={styles.shell}>
					...
					<div className={styles.heroTopRow}>
						<div>
							<h1 className={styles.heroHeading}>
								HTWind for Windows 11 desktops
							</h1>
							<p className={styles.heroDescription}>
								HTWind is a customizable desktop widget manager that lets you
								run rich HTML widgets, monitor your system, and execute
								PowerShell tools from a polished Windows-focused workspace.
							</p>
						</div>
				...
				<section className={styles.contentGrid}>
					<Card className={styles.card}>
						...
						<Subtitle1 className={styles.featureTitle}>
							HTML Widgets on Desktop
						</Subtitle1>
						<Body1 className={styles.featureDescription}>
							Build and run widgets with HTML, CSS, and JavaScript. Keep your
							tools always visible and fully customizable on your desktop.
						</Body1>
					</Card>
					...
					<Card className={styles.card}>
						...
						<Body1 className={styles.featureDescription}>
							Trigger safe, explicit PowerShell scripts through HTWind host APIs
							for quick diagnostics, automation, and system actions.
						</Body1>
					</Card>
					...
					<Card className={styles.card}>
						...
						<Body1 className={styles.featureDescription}>
							Designed for modern Windows workflows with tray behavior,
							pin-on-top controls, and state persistence tuned for desktop
							productivity, including display-aware suppression options for
							fullscreen and maximized foreground apps.
						</Body1>
					</Card>
				</section>
				...
				<section>
					<Card className={styles.widgetsCard}>
						...
						<Body1 className={styles.featureDescription}>
							...
							controls, file operations, and quick actions.
						</Body1>
				...
				<section aria-labelledby="htwind-overview-heading">
					<Card className={styles.longFormSection}>
						...
						<p className={styles.sectionLead}>
							HTWind is a Windows desktop widget manager that combines native
							app behavior with flexible web content. By using HTML widgets and
							WebView2 rendering, the platform makes it easier to build desktop
							tools that stay accessible while you work. Typical setups include
							clock and calendar utilities, system monitoring dashboards, and
							quick command launchers that remain visible across multi-window
							workflows.
						</p>
						<p className={styles.sectionLead}>
							The project is designed for users who want a lightweight but
							extensible desktop customization layer. With tray integration,
							pin-on-top window controls, state persistence, and template-based
							widgets, HTWind helps turn a standard Windows 11 workspace into a
							more actionable and information-rich environment without requiring
							heavy desktop shell replacements. Settings also include
							display-aware suppression modes that temporarily close widget
							windows while other apps are fullscreen or maximized.
						</p>
				...
				<section aria-labelledby="htwind-use-cases-heading">
					<Card className={styles.longFormSection}>
						...
						<p className={styles.sectionLead}>
							...
							practical Windows 11 widget platform in both personal productivity
							and technical operations contexts.
						</p>
				...
				<section aria-labelledby="htwind-faq-heading">
					<Card className={styles.longFormSection}>
						...
						<p className={styles.sectionLead}>
							Quick answers for users searching for a Windows HTML widget
							manager with PowerShell integration and open-source customization.
						</p>
				...
				<section aria-labelledby="htwind-community-sharing-heading">
					<Card className={styles.communitySection}>
						...
						<p className={styles.sectionLead}>
							HTWind supports a community-driven workflow where users publish
							and discuss widget ideas directly in GitHub Discussions and in the
							HTWind Reddit community. This makes it easy to exchange desktop
							widget templates, compare approaches for Windows automation, and
							improve widget quality through real usage feedback.
						</p>
						<p className={styles.sectionLead}>
							If you build a clock variation, a system monitor, a file utility
							panel, or any custom HTML widget, you can post it in both channels
							so others can test and adapt it. Include screenshots, usage notes,
							and integration details to help users quickly adopt your widget in
							their own HTWind setup.
						</p>
						<ul className={styles.bulletList}>
						...
						<Body1>
							...
							to publish widgets, report bugs, request features, and share
							desktop setups.
						</Body1>
					</Card>
				</section>
				...
				<section aria-labelledby="support-developer-heading">
					<Card className={styles.longFormSection}>
						<h2
							id="support-developer-heading"
							className={styles.sectionHeading}
						>
							Support the developer
						</h2>
						<p className={styles.sectionLead}>
							You can support sustainable development of HTWind and help the
							project continue to grow by visiting the support page.
						</p>
						<Body1>
							Support link:{" "}
